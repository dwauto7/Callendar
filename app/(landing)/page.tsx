...
export default function LandingPage() {
  return (
    ...
    <div className="bg-background min-h-screen flex flex-col aurora-bg relative overflow-hidden">
      ...
      />
      {/* Glassy ambient gradient for depth */}
      ...
      <div
        className="absolute -bottom-40 left-1/2 h-[520px] w-[1200px] -translate-x-1/2 rounded-full opacity-[0.12] blur-[120px] pointer-events-none"
        style={{
          background:
