      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 border border-[#40E0FF]/20 bg-[#40E0FF]/10 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-[10px] font-black text-[#40E0FF] uppercase tracking-[0.25em]">The Outcomes</span>
          </div>
          <h2
          ...
          <p className="text-[#D9E4E6]/65 max-w-xl mx-auto text-sm leading-relaxed">
            Keep your number, keep your tools. We plug in and start capturing bookings in days.
          </p>
        </div>

        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="hidden md:block absolute top-12 left-[20%] right-[20%] h-[1px] bg-gradient-to-r from-[#40E0FF]/0 via-[#40E0FF]/45 to-[#40E0FF]/0" />

          {steps.map(({ number, icon: Icon, title, description }) => (
            <div key={number} className="relative flex flex-col items-center text-center">
              <div className="relative z-10 size-20 rounded-2xl flex items-center justify-center mb-6 border border-[#40E0FF]/20 bg-[#40E0FF]/10">
                <Icon className="size-8 text-[#40E0FF]" />
                <span
                  className="absolute -top-3 -right-3 size-8 rounded-xl flex items-center justify-center text-[11px] font-black border border-[#253236] bg-[#101416] text-[#40E0FF]"
                >
                  {number}
                </span>
              </div>
              ...
              <p className="text-sm text-[#D9E4E6]/60 leading-relaxed max-w-[260px]">
                {description}
              </p>
            </div>
          ))}
